...
public protocol CoreProtocol: ~Copyable, SendableMetatype {
    ...
    /// Sets up things necessary for general core usage. No game is targeted yet.
    /// - Parameters:
    ...
    /// Adds the given cheats and sets them as active.
    /// - Parameter cheats: A list of active cheats.
    mutating func setCheats(cheats: [CoreCheat])

    /// Removes all active cheats from the core
    mutating func clearCheats()
}
